...
node(){
    ...
    stage('checkout')
   // checkout([$class: 'GitSCM', branches: [[name: 'refs/heads/develop']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'SparseCheckoutPaths', sparseCheckoutPaths: [[path: 'test/']]]], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '277ec06f-179d-4198-9ef6-ce88e0b98a96', url: 'https://github.com/kanny18/test.git']]])
    //checkout([$class: 'GitSCM', branches: [[name: 'refs/heads/develop']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'SparseCheckoutPaths', sparseCheckoutPaths: [[path: 'test/']]]], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '277ec06f-179d-4198-9ef6-ce88e0b98a96', url: 'https://github.com/kanny18/myrepo.git']]])
    ...
    checkout([$class: 'GitSCM', branches: [[name: 'refs/heads/develop']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'RelativeTargetDirectory', relativeTargetDir:"script/"],[$class: 'SparseCheckoutPaths', sparseCheckoutPaths: [[path: 'test/']]]], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '277ec06f-179d-4198-9ef6-ce88e0b98a96', url: 'https://github.com/kanny18/test.git']]])
